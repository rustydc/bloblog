...
def make_consumer_node(
    input_channel: str, expected_count: int
) -> tuple[Callable[..., Awaitable[None]], list[str]]:
...
def make_transform_node(
    input_channel: str, output_channel: str, transform, expected_count: int
